  ...
  const handleSubmit = (e) => {
    ...
    return (
        ...
        <div className="w-full max-w-md">
          <h2 className="text-3xl font-bold text-gray-900 mb-10 text-left">Create New Password</h2>

          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              <label htmlFor="newPassword" className="text-base font-semibold text-gray-900">
                New Password
              </label>
              <input
                type="password"
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="retypePassword" className="text-base font-semibold text-gray-900">
                Retype Password
              </label>
            ...
            <button
              type="submit"
              className="bg-gray-200 text-gray-400 border-none p-4 rounded-lg text-base font-semibold cursor-not-allowed mt-4 transition-colors hover:bg-gray-300"
            >
              Update
            </button>
